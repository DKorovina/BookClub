...
package com.example.myapplication;
    ...
    public class main_recenz_activity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_recenz);
        ...
        news.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(main_recenz_activity.this, main_activity.class);
        ...
        citata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(main_recenz_activity.this, main_citata_activity.class);
